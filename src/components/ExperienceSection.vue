...
const experience = [
  ...
  },
  {
    ...
    period: '2020',
    points: [
      'Game testing across iOS, Android, PS4, Xbox One, PC, and macOS.',
      'Bug reporting via Mantis and JIRA in a multilingual, cross-functional team.',
      'Produced daily and weekly test summary reports.',
    ],
